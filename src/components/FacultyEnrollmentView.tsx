...
const FacultyEnrollmentView = ({ userId }: { userId: string }) => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-3xl font-bold mb-2">Course Registration</h2>
        <p className="text-muted-foreground">
          Register for courses as a participant
        </p>
      </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-2xl font-bold">My Registered Courses</h3>
          <Dialog>
            ...
            <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
              <DialogHeader>
                ...
                <DialogDescription>
                  Browse and register for courses taught by other faculty
                </DialogDescription>
              </DialogHeader>
...
export default FacultyEnrollmentView;
